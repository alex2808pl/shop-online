...
CREATE TABLE orders (OrderID INT AUTO_INCREMENT NOT NULL, UserID INT NULL, CreatedAt datetime NULL, UpdateAt datetime NULL, ContactPhone VARCHAR(255) NULL, DeliveryAddress VARCHAR(255) NULL, DeliveryMethod VARCHAR(255) NULL, Status ENUM('OPEN', 'CLOSE') NULL, CONSTRAINT PK_ORDERS PRIMARY KEY (OrderID));
