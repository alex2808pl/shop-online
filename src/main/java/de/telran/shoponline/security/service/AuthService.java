package de.telran.shoponline.security.service;
...
import de.telran.shoponline.security.jwt.JwtProvider;
...
public class AuthService {
    ...
    public JwtResponse login(JwtRequest authRequest) throws AuthException {
        final UsersDto userDto = usersService.getByEmail(authRequest.getLogin());
    ...
    public JwtResponse getAccessToken(@NonNull String refreshToken) throws AuthException {
        ...
        if (jwtProvider.validateRefreshToken(refreshToken)) {
            ...
            if (savedRefreshToken != null && savedRefreshToken.equals(refreshToken)) {
                // Fetch the user data
                final UsersDto userDto = usersService.getByEmail(login);
                if(userDto==null) new AuthException("User is not found");
    ...
    public UsersDto createUser(UsersDto userCredentialsDto) throws ResponseException {
        return usersService.createUser(userCredentialsDto);
    }
}
