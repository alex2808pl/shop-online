...
import de.telran.shoponline.security.service.AuthService;
...
public class AuthController {
    ...
    public ResponseEntity<UsersDto> register(@RequestBody UsersDto userCredentialsDto) throws ResponseException {
        UsersDto userDto = authService.createUser(userCredentialsDto);
